package com.alllexe.RestKafka.config;
...
public class Config {
    ...
    public ReplyingKafkaTemplate<String, Request, Response> replyingKafkaTemplate(ProducerFactory<String, Request> pf,
                                                                              KafkaMessageListenerContainer<String, Response> container){
    ...
    @Bean
    public ConsumerFactory<String, Response> replyConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(
                consumerConfigs(),
                new StringDeserializer(),
    ...
    @Bean
    public KafkaMessageListenerContainer<String, Response> replyContainer(ConsumerFactory<String, Response> cf) {
        ContainerProperties containerProperties = new ContainerProperties(sumReplyTopic);
